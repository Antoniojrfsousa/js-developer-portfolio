...
function updatePortfolio(profileData) {
    const profile = document.getElementById('profile.portifolio')

    profile.innerHTML = profileData.portfolio.map(portfolio => {
        return `
        <li>
            <h3 ${portfolio.git ? 'class="github"' : ''}>${portfolio.name}</h3>
